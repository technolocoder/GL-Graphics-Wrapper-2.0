...
public:
    model();
    model(std::string filepath,bool _gamma_corrected=false);
    void initialize(std::string filepath, bool _gamma_corrected=false);
...
private:
    ...
    void load_material(aiMaterial *material,aiTextureType ai_textype, TEXTURE_TYPE texture_type, int count, texture_2d *textures, bool gamma_corrected);
